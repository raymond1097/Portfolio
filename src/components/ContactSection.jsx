  ...
  return (
    <section id='contact' className='py-24 px-4 relative bg-secondary/30'>
      <div className="container mx-auto max-w-5xl">
        ...
        <p className='text-center text-muted-foreground mb-12 max-w-2xl mx-auto'>Have a project in mind or want to collaborate? Feel free to reach out.
            ...
            <div className='space-y-8'>
              ...
              <div className='space-y-6 justify-center'>
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <a href="mailto:kajogbolaabdulrahmonbolaji@gmail.com" className='text-muted-foreground hover:text-primary transition-colors'>
                      kajogbolaabdulrahmonbolaji@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <a href="tel:+234 810-237-8627" className='text-muted-foreground hover:text-primary transition-colors'>
                      +234 810-237-8627
                    </a>
                  </div>
                </div>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <a className='text-muted-foreground hover:text-primary transition-colors'>
                      Ikola Command, Lagos State, Nigeria.
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className='pt-8'>
                ...
                <div className='flex space-x-4 justify-center'>
                  <a href="https://www.linkedin.com/in/abdulrahmon-kajogbola-1a925b261" target='_blank'>
                    <Linkedin />
                  </a>
                  <a href="https://x.com/OfficialBj20" target='_blank'>
                    <Twitter />
                  </a>
                  <a href="https://www.instagram.com/officialray10/" target='_blank'>
                    <Instagram />
                  </a>
                </div>
              </div>
